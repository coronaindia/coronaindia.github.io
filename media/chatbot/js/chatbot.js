...
function start_over() {
  ...
  score = 0;
  quiz_score = 0;
  $('<li class="replies"><p>Hello I am Corona Bot. And I am here to help you to diagnose with novel corona virus.</p></li>').appendTo($('.messages ul'));
  ...
  $('<li class="sent"> <button type="button" class="btn btn-success" onclick="start()">Let\'s Start. &#128077;</button> <button type="button" class="btn btn-danger" onclick="quiz()">Take Corona Quiz. &#129299;</button> </li>').appendTo($(
    '.messages ul'));
  //start();
}

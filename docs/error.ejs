...
<head>
	...
	<meta property="og:url" content="https://elcomrades.github.io/COVID19/" />
	...
	<meta property="og:image" content="https://elcomrades.github.io/COVID19/dist/img/fsharevirus.png">
  ...
  <!--Custom -->
  <link rel="stylesheet" href="../media/misc/css/index.css" type="text/css" />

</head>

<body class="hold-transition sidebar-mini layout-fixed" id="pagescroll">
	<div class="wrapper">
		...
		<nav class="main-header navbar navbar-expand navbar-white navbar-light">
			...
			<ul class="navbar-nav">
				<li class="nav-item">
					<a class="nav-link" data-widget="pushmenu" href="#"><img class="img" src="../media/images/open-menu.svg" width="20px" height="20px">
					</a>
				</li>

				<li class="nav-item mt-2 ">
					<a href="" style="color:black;"><b>Dashboard for COVID-19 Virus Outbreak in INDIA </b><img class="img" src="../media/images/indianflag.svg" width="20px" height="20px"></a>
				</li>
			...
			<ul class="navbar-nav ml-auto">
				...
				<!-- <a href="" class="nav-link" style="color:black;"><b>Ask Corona Bot</b></a> -->
				...
				<li class="nav-item">
					<form class="form-inline">
						<!-- <a class="nav-link" data-widget="control-sidebar" data-slide="true" href="#"><b>Ask Corona Bot</b> -->
						<h5 style="cursor: pointer;"><span class="badge badge-secondary" data-widget="control-sidebar" data-slide="true">Ask Corona Bot <i class="far fa-hand-point-right"></i></span><img class="direct-chat-img animated flip delay-0.2s"
								data-widget="control-sidebar" data-slide="true" src="../media/images/bot.svg" style="float: right;">
							<h5>
				...
				<nav class="mt-2">
				 ...
				 with font-awesome or any other icon font library -->
					 ...
					 &nbsp;&nbsp;&nbsp;<a target="_blank" href="https://twitter.com/intent/tweet?button_hashtag=indiafightscorona&ref_src=twsrc%5Etfw">#indiafightscorona</a>
							...
							<a class="fab fa-linkedin shadow" title="Share via Linkedin" target="_blank" href="https://www.linkedin.com/shareArticle?mini=true&url=https://elcomrades.github.io/COVID19/&title=#indiafightscorona&source=https://elcomrades.github.io"></a>



						</li>
						<li class="nav-item ml-3 mt-1">
							<a href="https://www.instagram.com/?url=https://elcomrades.github.io/COVID19/" title="Share via Instagram" target="_blank" class="fab fa-instagram shadow"></a>

						</li>
						<li class="nav-item ml-3 mt-1">
							<a class="fab fa-facebook shadow" target="_blank" title="Share via Facebook" href="https://www.facebook.com/sharer.php?u=https://elcomrades.github.io/COVID19/"></a>

						</li>
						<li class="nav-item ml-3 mt-1">
							<a target="_blank" title="Share via Whatsapp" href="whatsapp://send?&text= COVID-19 INDIA Dashboard https://elcomrades.github.io/COVID19/" class="fab fa-whatsapp shadow"></a>
    ...
    <!-- /.content-wrapper -->
		...
		<footer class="main-footer">
			<strong><img class="img" src="../media/images/copyright.svg" width="15px" height="15px">2020 <a href="">elComrades</a></strong>

			<div class="float-right d-none d-sm-inline-block">
				<strong>Designed & Developed By <a href="">elComrades</a></strong>
			</div>
		</footer>

		<!-- Control Sidebar -->
		<!-- Control Sidebar -->
		<aside class="control-sidebar bg-white" style="width:400px !important;overflow-y:auto !important;">
			...
			<div id="frame">
				...
				<div class="content shadow" style="    height: 685px;">
					<div class="contact-profile shadow rounded border border-dark">
						<img src="../media/images/bot.svg" class="img animated flip delay-0.2s">
						<h4><span class="animated fadeIn delay-0.2s ">Corona Bot</span></h4>
						<h6><span class="badge badge-success" onclick="start_over();" style="cursor: pointer;"><i class="fas fa-sync-alt"></i> Start Again</span></h6>
					</div>
